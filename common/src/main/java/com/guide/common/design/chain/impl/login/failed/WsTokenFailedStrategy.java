 ...
 */
@Slf4j
public class WsTokenFailedStrategy extends AbstractStrategyRouter<LoginInfo, JSONObject>
        implements StrategyHandler<LoginInfo, String>
{
    ...
    {
        return (param) -> new WsGuestStrategy();
    }
    ...
    {
        return applyStrategy(param).toJSONString();
    }
}
